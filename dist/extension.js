...
const processController_1 = __webpack_require__(9);
class SushiWrapper {
    constructor() {
    ...
    getDiagnostics(logOutput) {
        ...
        while ((m = regex.exec(logOutput)) !== null) {
            ...
            if (m.groups?.message) {
                ...
                output.push(new diagnostic_1.Diagnostic(severityType, m.groups?.message, m.groups?.file, new vscode_1.Range(lineFrom, 0, lineTo, 200)));
            }
        }
        return output;
    }
...
const hapiOutputParser_1 = __webpack_require__(12);
class HapiController {
    constructor(diagnosticCollection) {
        ...
        this.hapiWrapper = new hapiWrapper_1.HapiWrapper("C:/Users/robho/.fhir/validators/validator_cli_v5.6.89.jar", "C:/dev/spec-erezept-medicationrequest-communication/Resources/sushi-config.yaml", "C:/dev/spec-erezept-medicationrequest-communication/scripts/validation_script-config.yaml");
        this.diagnosticController = new diagnosticController_1.DiagnosticController(diagnosticCollection);
        this.hapiOutputParser = new hapiOutputParser_1.HapiOutputParser();
    }
    checkHapiInstallation() {
...
const hapiParameter_1 = __webpack_require__(41);
const dependency_1 = __webpack_require__(40);
const processController_1 = __webpack_require__(9);
const proxySettings_1 = __webpack_require__(13);
const yaml = __webpack_require__(14);
const fs = __webpack_require__(39);
class HapiWrapper {
    constructor(validatorDestination, sushiConfigDestination, proxyConfigDestination) {
    ...
    getParameter() {
        return new Promise((resolve, reject) => {
            ...
            resolve(new hapiParameter_1.HapiParameter(dependencies, proxy));
        });
    }
    formatProxySettiungs(settings) {
        if (settings.active) {
    ...
    getProxySettings() {
        ...
        return new proxySettings_1.ProxySettings(true, "192.168.110.10:3128");
    }
    formatDepencencies(dependencies) {
        let result = [];
    ...
    getDependencies() {
        ...
        //TODO: Parse dependencies
        let dependencies = [];
        dependencies.push(new dependency_1.Dependency("hl7.fhir.r4.core", "4.0.1"));
        dependencies.push(new dependency_1.Dependency("de.basisprofil.r4", "1.4.0"));
        dependencies.push(new dependency_1.Dependency("de.gematik.erezept-workflow.r4", "1.2.0"));
        dependencies.push(new dependency_1.Dependency("de.gematik.fhir.directory", "0.9.0"));
        dependencies.push(new dependency_1.Dependency("kbv.basis", "1.3.0"));
        dependencies.push(new dependency_1.Dependency("kbv.ita.for", "1.1.0"));
        dependencies.push(new dependency_1.Dependency("kbv.ita.erp", "1.1.0"));
        return dependencies;
    }
    parseConfig(configDestination) {
        try {
    ...
    getDiagnostics(logOutput, filetoValidate) {
        ...
        while ((m = regex.exec(logOutput)) !== null) {
            ...
            if (m.groups?.message) {
                ...
                output.push(new diagnostic_1.Diagnostic(severityType, m.groups?.message, filetoValidate, new vscode_1.Range(lineFrom, colFrom, lineFrom, 200)));
            }
        }
        return output;
    }
...
var dumper = __webpack_require__(38);
...
module.exports.Type = __webpack_require__(24);
...
module.exports.types = {
  ...
  float:     __webpack_require__(31),
  map:       __webpack_require__(27),
  null:      __webpack_require__(28),
  pairs:     __webpack_require__(36),
  set:       __webpack_require__(37),
  timestamp: __webpack_require__(32),
  bool:      __webpack_require__(29),
  int:       __webpack_require__(30),
  merge:     __webpack_require__(33),
  omap:      __webpack_require__(35),
  seq:       __webpack_require__(26),
  str:       __webpack_require__(25)
};
...
var makeSnippet         = __webpack_require__(18);
var DEFAULT_SCHEMA      = __webpack_require__(19);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.HapiParameter = void 0;
class HapiParameter {
    constructor(dependencies, proxy) {
        this.version = "-version 4.0.1"; // FHIR Version to use
        this.dependencies = dependencies;
        this.proxy = proxy;
    }
}
exports.HapiParameter = HapiParameter;
...
function activate(context) {
    ...
    let runHapiSubscription = vscode.commands.registerCommand('codfsh.runHapi', () => {
        let hapiController = new hapiController_1.HapiController(diagnosticCollection);
