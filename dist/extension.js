...
const diagnosticManipulator_1 = __webpack_require__(6);
    ...
    getDiagnostics(logOutput) {
        ...
        while ((m = regex.exec(logOutput)) !== null) {
            ...
            if (m.groups?.message) {
                ...
                const dia = new diagnostic_1.Diagnostic(severity, m.groups?.message, m.groups?.file, range);
                console.log(dia);
                output.push(dia);
            }
        }
...
const promises_1 = __webpack_require__(11);
class PathController {
    ...
    async tryGetConfigPath(filename) {
    ...
    async locateConfigFile(filename) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.PathValues = void 0;
class PathValues {
    constructor(sushiConfigPath, ressourceFolderPath) {
...
class ConfigHandler {
    ...
    getMinVersion(isLocalProjectSettingsFileActive, localConfigPath, program) {
        if (!isLocalProjectSettingsFileActive) {
            let config = this.getExtensionConfiguration();
            return this.getSettingsFromYamlFile(config.get(program), program + ".min_version");
        }
    ...
    getSushiSettings(section) {
        ...
        return new sushiSettings_1.SushiParameters(buildSnapshots);
    }
    isLocalProjectSettingsFileActive() {
        return this.isSectionDefined(this.getExtensionConfiguration().get("Settings.UseProjectSettingFiles"), "Settings.UseProjectSettingFiles");
    }
    getHapiParametersFromExtensionConfig() {
        ...
        const additionalParameter = config.get("HapiValidator.Settings" + '.AdditionalParameters');
        const additionalParametersObj = additionalParameter ? this.parseAdditionalParameters(additionalParameter) : {};
        return { ...globalSettingsFileParameters, ...additionalParametersObj };
    }
    parseAdditionalParameters(additionalParameter) {
    ...
    getSettingsFromYamlFile(filePath, yamlProperty) {
        if (!filePath) {
    ...
    getParametersFromSettingsFile(filePath, program) {
        return this.getSettingsFromYamlFile(filePath, program + ".parameters");
    }
    getMinVersionFromSettingsFile(filePath, program) {
        return this.getSettingsFromYamlFile(filePath, program + ".min_version");
    }
    getIgnoredDiagnosticsFromSettingsFile(filePath, program) {
        return this.getSettingsFromYamlFile(filePath, program + ".ignore");
    }
    getParametersFromGlobalSettingsFile(section, program) {
        let config = this.getExtensionConfiguration();
        let filePath = config.get(section);
    ...
    getParametersFromLocalSettingsFile(filePath, program) {
...
var dumper = __webpack_require__(40);
...
module.exports.DEFAULT_SCHEMA = __webpack_require__(21);
module.exports.load                = loader.load;
module.exports.loadAll             = loader.loadAll;
module.exports.dump                = dumper.dump;
module.exports.YAMLException = __webpack_require__(19);

// Re-export all types in case user wants to create custom schema
module.exports.types = {
  binary:    __webpack_require__(36),
  float:     __webpack_require__(33),
  map:       __webpack_require__(29),
  null:      __webpack_require__(30),
  pairs:     __webpack_require__(38),
  set:       __webpack_require__(39),
  timestamp: __webpack_require__(34),
  bool:      __webpack_require__(31),
  int:       __webpack_require__(32),
  merge:     __webpack_require__(35),
  omap:      __webpack_require__(37),
  seq:       __webpack_require__(28),
...
var makeSnippet         = __webpack_require__(20);
var DEFAULT_SCHEMA      = __webpack_require__(21);
...
class HapiController {
    constructor(debugHandler, diagnosticCollection, diagnosticController = new diagnosticController_1.DiagnosticController(debugHandler, diagnosticCollection), configHandler = new configHandler_1.ConfigHandler(debugHandler), fileHandler = new fileHandler_1.FileHandler(debugHandler), pathController = new pathController_1.PathController(debugHandler), dependencyController = new dependencyController_1.DependencyController(debugHandler, pathController), hapiWrapper = new hapiWrapper_1.HapiWrapper(debugHandler, configHandler), hapiOutputParser = new hapiOutputParser_1.HapiOutputParser(debugHandler), fileConnector = new fileConnector_1.FileConnector(debugHandler), errorHandler = new errorHandler_1.ErrorHandler(debugHandler), notificationController = new notificationController_1.NotificationController(debugHandler), localConfigPath = "", isLocalProjectSettingsFileActive = false) {
        ...
        this.isLocalProjectSettingsFileActive = isLocalProjectSettingsFileActive;
    }
    ...
    async isValidatorVersionValid(validatorDestination, localConfigPath) {
    ...
    async processValidationResults(consoleOutput, numberOfFiles) {
...
const processController_1 = __webpack_require__(44);
class HapiWrapper {
    constructor(debugHandler, configHandler) {
        this.debugHandler = debugHandler;
        this.processController = new processController_1.ProcessController(this.debugHandler);
        this.configHandler = configHandler;
    }
    async getConsoleOutput(validatorDestination, filesToValidate, dependencies, validatorParameters) {
    ...
    async getValidatorVersion(validatorDestination) {
...
const hapiController_1 = __webpack_require__(47);
const debugHandler_1 = __webpack_require__(56);
